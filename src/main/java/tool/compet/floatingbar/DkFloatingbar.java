...
public abstract class DkFloatingbar implements View.OnTouchListener {
	...
	public abstract DkFloatingbar message(int msgRes);
	public abstract DkFloatingbar message(CharSequence msg);
	public abstract DkFloatingbar duration(long millis);
	public DkFloatingbar setAction(int textRes, DkRunner onClickListener) {
		return this;
	}

	public DkFloatingbar asError() {
		return color(TYPE_ERROR);
	}

	public DkFloatingbar asWarning() {
		return color(TYPE_WARNING);
	}

	public DkFloatingbar asConfirm() {
		return color(TYPE_CONFIRM);
	}

	public DkFloatingbar asSuccess() {
		return color(TYPE_SUCCESS);
	}

	public DkFloatingbar asInfo() {
		return color(TYPE_INFO);
	}

	public DkFloatingbar color(int color) {
